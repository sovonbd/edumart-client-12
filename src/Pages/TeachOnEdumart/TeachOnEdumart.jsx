          ...
          <Grid item xs={12} sm={6} md={5} elevation={6} square>
            <Box
              ...
              <Typography
                ...
                Having thoroughly completed the form to review, I've realized my
                passion for education and am now eager to embark on the
                fulfilling journey of becoming a teacher, nurturing young minds
