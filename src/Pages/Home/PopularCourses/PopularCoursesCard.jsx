const PopularCoursesCard = ({ course }) => {
  ...
  return (
    <div className="space-y-2 shadow-md rounded-md p-2 hover:scale-105 hover:shadow-lg border-[1px] hover:duration-300">
      <img src={image} className="w-52 h-40 rounded-md" alt="" />
